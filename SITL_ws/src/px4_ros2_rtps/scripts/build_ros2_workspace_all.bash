...
cd $ROS_WS_DIR && colcon build --cmake-args -DCMAKE_BUILD_TYPE=RELWITHDEBINFO --symlink-install --packages-select more_interfaces px4_msgs px4_ros_com $colcon_output
